...
@interface FFTDemoBaseViewController () <UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) UITableView *optionsTableView;

@end

@implementation FFTDemoBaseViewController

/** Singleton Mode */
SingletonM(FFTDemoBaseViewController)
...
- (void)handleOption:(NSString *)key forChartView:(ChartViewBase *)chartView
{
    ...
    if ([key isEqualToString:@"clearChart"])
    {
    ...
    {
        [chartView animateWithXAxisDuration:1.0];
    }
    
    if ([key isEqualToString:@"animateY"])
    {
        [chartView animateWithYAxisDuration:1.0];
    }
    
    if ([key isEqualToString:@"animateXY"])
    {
        [chartView animateWithXAxisDuration:1.0 yAxisDuration:1.0];
    }
...
- (IBAction)optionsButtonTapped:(id)sender
{
    ...
    _optionsTableView.backgroundColor = [UIColor colorWithWhite:1.f alpha:0.8f];
    ...
    [constraints addObject:[NSLayoutConstraint constraintWithItem:_optionsTableView attribute:NSLayoutAttributeLeading relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeLeading multiplier:1.f constant:300.f]];
    ...
    [constraints addObject:[NSLayoutConstraint constraintWithItem:_optionsTableView attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:sender attribute:NSLayoutAttributeTop multiplier:1.f constant:130.f]];
    ...
    [_optionsTableView addConstraints:@[
                                        [NSLayoutConstraint constraintWithItem:_optionsTableView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeHeight multiplier:1.f constant:105.f]
                                        ]];
}
